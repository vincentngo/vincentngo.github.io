...
- **[designdotmd.directory](https://designdotmd.directory/)** — A curated directory of `DESIGN.md` files and design system resources from across the community.
...
- **Community Directory:** [designdotmd.directory](https://designdotmd.directory/) — Browse curated `DESIGN.md` files and design system resources
