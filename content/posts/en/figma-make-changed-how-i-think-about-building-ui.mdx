...
- [Introducing Claude Code to Figma](https://www.figma.com/blog/introducing-claude-code-to-figma/) — Figma's official announcement on Claude Code integration
- [Figma Community Gallery](https://www.figma.com/gallery/) — Browse community-made templates and design resources
- [Explore Figma Make](https://help.figma.com/hc/en-us/articles/31304412302231-Explore-Figma-Make) — Official guide to getting started with Figma Make
